...
import { Users, Calendar, MapPin, AlertTriangle, Settings, ClipboardList, BarChart3 } from 'lucide-react'
...
export default async function AdminDashboard() {
  ...
  const cards = [
    ...
    { label: 'Analytics', value: '', sub: 'Volunteers', href: '/admin/analytics', icon: BarChart3, color: 'bg-amber-50 text-amber-600' },
