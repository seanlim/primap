...
export const TABLE_COLUMNS: Record<TableName, string[]> = {
  ...
  walk_slots: ['id', 'round_id', 'location_name', 'walk_date', 'start_time', 'end_time', 'max_volunteers', 'reminder_sent_at', 'created_at', 'updated_at'],
  ...
  app_settings: ['id', 'required_walks_per_round', 'high_participation_threshold', 'max_media_per_report', 'reminder_send_weekday', 'reminder_send_time', 'reminder_window_start_offset_days', 'reminder_window_length_days', 'created_at', 'updated_at'],
}
