DROP FUNCTION IF EXISTS public.join_slot_with_observation(uuid, uuid) CASCADE;

-- Create new RPC that handles per-slot observations
...
BEGIN
  ...
  INSERT INTO public.observations (slot_id, status)
  VALUES (p_slot_id, 'DRAFT')
